...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initOne() {
        ...
        FSelector.with(tvtext1)
                ...
                .storkeWidth(dp2px(3)).strokeClr(getColors(R.color.clr_cdcdcd)).create()
                .addDrawable(STATE_PRESSED).circleAngle(dp2px(5)).stateDraw(selectDrawable)
                .storkeWidth(dp2px(3)).strokeClr(Color.RED).create()
                .bind();
    }
    private void initTwo() {
        FSelector.with(tvtext2)
                .addDrawable().circleAngle(dp2px(5)).bgColor(getColors(R.color.clr_f6f6f6))
                .storkeWidth(dp2px(1)).strokeClr(getColors(R.color.clr_cdcdcd)).create()
                .addDrawable(STATE_PRESSED).circleAngle(dp2px(5)).bgColor(getColors(R.color.clr_fffcf7))
                .storkeWidth(dp2px(1)).strokeClr(getColors(R.color.clr_fb720e)).create()
                .bind();
    }
    ...
    private void initFive() {
        FSelector.with(tvtext5)
                .addDrawable().circleAngle(dp2px(15)).bgColor(getColors(R.color.clr_fb720e))
                .create()
                .addDrawable(STATE_PRESSED).circleAngle(dp2px(15)).bgColor(Color.RED)
                .create()
                .bind();
    }
    private void initSix() {
        ...
        FSelector.with(tvtext6)
                .addDrawable().circleAngle(dp2px(5)).bgColor(getColors(R.color.clr_f6f6f6))
                .storkeWidth(dp2px(5)).strokeClr(getColors(R.color.clr_cdcdcd)).create()
                .addDrawable(STATE_PRESSED).circleAngle(dp2px(5)).stateDraw(shapeBitmapDrawable)
                .storkeWidth(dp2px(5)).strokeClr(Color.RED).create()
                .bind();
    }
